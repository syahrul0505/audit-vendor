...
<div class="col-lg-12 col-md-12 col-sm-12">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="d-flex justify-content-center title mt-3" data-aos="zoom-in">Pengelolaan</div>
            </div>
        </div>
    </div>
    ...
    <div class="container mt-4">
        <div class="row ">
            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 col-gmb">
                <div class="row" data-aos="fade-down" data-aos-delay="200">
                    <div class="col-6 gmb2-kanan">
                        <img src="{{ asset('assets/images/LAINNYA/LAINNYA - DOKUMENTASI KEGIATAN/PENGELOLAAN/IMG-20181128-WA0042.jpg') }}" class="img-fluid gmb2" alt="">
                    </div>
                    <div class="col-6 gmb2-kiri">
                        <img src="{{ asset('assets/images/LAINNYA/LAINNYA - DOKUMENTASI KEGIATAN/PENGELOLAAN/Ling 5.jpg') }}" class="img-fluid gmb2" alt="">
                    </div>
                </div>

                <div class="row" data-aos="fade-down">
                    <div class="col-6 gmb2-kanan">
                        <img src="{{ asset('assets/images/LAINNYA/LAINNYA - DOKUMENTASI KEGIATAN/PENGELOLAAN/Ling 6.jpg') }}" class="img-fluid gmb2" alt="">
                    </div>
                    <div class="col-6 gmb2-kiri">
                        <img src="{{ asset('assets/images/LAINNYA/LAINNYA - DOKUMENTASI KEGIATAN/PENGELOLAAN/IMG-20190204-WA0019.jpg') }}" class="img-fluid gmb2" alt="">
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12" data-aos="fade-right"> 
                <img src="{{ asset('assets/images/LAINNYA/LAINNYA - DOKUMENTASI KEGIATAN/PENGELOLAAN/IMG-20170114-WA0008.jpg') }}" class="img-fluid gmb1" alt="">
            </div>
        </div>
    </div>
...
{{-- Mario Jela Batch --}}
    <div class="container mt-4">
        <div class="row ">
            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12" data-aos="fade-right"> 
                <img src="{{ asset('assets/images/LAINNYA/LAINNYA - DOKUMENTASI KEGIATAN/PENGELOLAAN/Ling 1.jpg') }}" class="img-fluid gmb1" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 col-gmb">
                <div class="row" data-aos="fade-down" data-aos-delay="200">
                    <div class="col-6 gmb2-kanan">
                        <img src="{{ asset('assets/images/LAINNYA/LAINNYA - DOKUMENTASI KEGIATAN/PENGELOLAAN/20180224_095307.jpg') }}" class="img-fluid gmb2" alt="">
                    </div>
                    <div class="col-6 gmb2-kiri">
                        <img src="{{ asset('assets/images/LAINNYA/LAINNYA - DOKUMENTASI KEGIATAN/PENGELOLAAN/20180224_095357.jpg') }}" class="img-fluid gmb2" alt="">
                    </div>
                </div>

                <div class="row" data-aos="fade-down">
                    <div class="col-6 gmb2-kanan">
                        <img src="{{ asset('assets/images/LAINNYA/LAINNYA - DOKUMENTASI KEGIATAN/PENGELOLAAN/IMG_20190420_123725.jpg') }}" class="img-fluid gmb2" alt="">
                    </div>
                    <div class="col-6 gmb2-kiri">
                        <img src="{{ asset('assets/images/LAINNYA/LAINNYA - DOKUMENTASI KEGIATAN/PENGELOLAAN/IMG-20160816-WA0009.jpg') }}" class="img-fluid gmb2" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container mt-4">
        <div class="row ">
            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 col-gmb">
                <div class="row" data-aos="fade-down" data-aos-delay="200">
                    <div class="col-6 gmb2-kanan">
                        <img src="{{ asset('assets/images/LAINNYA/LAINNYA - DOKUMENTASI KEGIATAN/PENGELOLAAN/fotbar1.png') }}" class="img-fluid gmb2" alt="">
                    </div>
                    <div class="col-6 gmb2-kiri">
                        <img src="{{ asset('assets/images/LAINNYA/LAINNYA - DOKUMENTASI KEGIATAN/PENGELOLAAN/fotbar2.png') }}" class="img-fluid gmb2" alt="">
                    </div>
                </div>

                <div class="row" data-aos="fade-down">
                    <div class="col-6 gmb2-kanan">
                        <img src="{{ asset('assets/images/LAINNYA/LAINNYA - DOKUMENTASI KEGIATAN/PENGELOLAAN/fotbar3.png') }}" class="img-fluid gmb2" alt="">
                    </div>
                    <div class="col-6 gmb2-kiri">
                        <img src="{{ asset('assets/images/LAINNYA/LAINNYA - DOKUMENTASI KEGIATAN/PENGELOLAAN.png') }}" class="img-fluid gmb2" alt="">
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12" data-aos="fade-right"> 
                <img src="{{ asset('assets/images/LAINNYA/LAINNYA - DOKUMENTASI KEGIATAN/PENGELOLAAN/kegiatan.png') }}" class="img-fluid gmb1" alt="">
            </div>
        </div>
    </div>  
{{-- end Pengelolaan --}}
