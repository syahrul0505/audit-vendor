...
<section style="margin-top: 60px">
    ...
    <div class="card" style="z-index: 1; position: relative; bottom: 1000px;">
        ...
        <center><hr></center>
        <center><img src="{{ asset('assets/images/icons/message.png') }}" style="width: 250px; height: 250px; margin-bottom:10px;" alt="">
        <p style="font-size: 16px; text-align:center; width: 404px;">Silahkan cek email kamu untuk melakukan perubahan password</p></center>
    </div> 
    </div>
    </div>
</section>
