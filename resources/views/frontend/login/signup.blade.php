...
<div class="form-box">
    ...
    <label for="myInput" class="form-label">Ulangi Password</label>
    <div class="input-box form-control">
    <i class="fas fa-lock ficon"></i>
    <input class="isi" type="password" placeholder="Password" id="myInput">
    <span class="eye" onclick="myFunction()">
    ...
    <center><a href="{{ route('join') }}"><button class="login-btn mb-lg-4" type="button"> <span> Sign Up</span></button></a></center>
    <p style="text-align: center; font-weight:400;font-style:normal;font-size:14px;">
    <a href="{{ route('login') }}" style="text-align: center; font-weight:400;font-style:normal;font-size:14px; color: #029B4B"> Login</a> 
