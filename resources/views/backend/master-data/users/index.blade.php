      ...
      <div class="card-header bg-gray1" style="border-radius:10px 10px 0px 0px;">
        <div class="row">
          ...
          <div class="col-6 d-flex justify-content-end">
            <a href="{{ route('backend.users.create') }}" class="btn btn-md btn-info">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <div class="btn-group">
                  @can('user-edit')
                  <a href="{{ route('backend.users.edit', $user->id) }}" class="btn btn-warning text-white">
                    <i class="far fa-edit"></i>
                    Edit
                  </a>
                  @endcan
                  @if(auth()->user()->can('user-delete') && Auth::user()->id != $user->id)
                  <a href="#" class="btn btn-danger f-12" onclick="modalDelete('User', '{{ $user->username }}', '/yakesma/admin/master-data/users/' + {{ $user->id }}, '/yakesma/admin/master-data/users/')">
